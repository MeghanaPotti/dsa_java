...
//		System.out.println("Unicode of character is "+name.codePointAt(2)); 
		...
		System.out.println("Comparision value is "+string2.compareTo(string1));
		...
		copyString = String.copyValueOf(string,0,5);
		...
		System.out.println("comparision status is "+string1.equals(string2));
		...
		System.out.println("concatination of name and location with operator is "+name+" "+location); 
